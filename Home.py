...
st.markdown(
    ...
    **👈 你可以从左侧边栏选择想要使用的程序!**
    ...
    ### 每个程序是干什么的?
    - [Leaguepedia](https://limuxuale0927-blgstreamlit-home-hdnf49.streamlitapp.com/Leaguepedia): 英雄联盟全球联赛数据看板
    - [DailyRank](https://limuxuale0927-blgstreamlit-home-hdnf49.streamlitapp.com/DailyRank): 批量查询选手过去7天韩服Rank数量
